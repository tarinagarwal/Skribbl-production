    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full mx-4">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600">Select a word to draw</p>
          <div className="mt-4">
            <div className="flex items-center justify-center gap-2">
              <Clock
                size={20}
        ...
        <div className="space-y-3">
          {words.map((word, index) => (
            <button
              ...
              className="w-full p-4 text-left bg-gray-50 hover:bg-purple-50 border-2 border-gray-200 hover:border-purple-300 rounded-lg transition-all duration-200 transform hover:scale-105"
            >
